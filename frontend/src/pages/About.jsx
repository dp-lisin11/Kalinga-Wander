      ...
      <Container>
        ...
        <Row>
          ...
          <Col md="3">
            <div class="grid-child purple  container mx-auto ">
              <div className="card">
                <img className="card-img-top " src={dpimg} alt="Card image" />
                <div className="card-body">
                  <h4 className="card-title">Dibyalipsa Patra</h4>
                  <p className="card-text">dp.lisin11@gmail.com</p>
                  <a
                    href="https://www.linkedin.com/in/dibyalipsa-patra-912159203/"
                    target="blank"
                    class="btn btn-lg primary__btn"
                  >
                    See Profile
